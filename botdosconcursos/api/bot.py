...
TOKEN = os.environ.get("TELEGRAM_BOT_TOKEN")  # Configure esta variável no Vercel
WEBHOOK_URL = os.environ.get("WEBHOOK_URL", "https://botdosconcursos-7sb4uqxmc-elinaldo99s-projects.vercel.app/api/bot")
